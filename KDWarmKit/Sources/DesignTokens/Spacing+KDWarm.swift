...
public enum KDSpacing {
    ...
    public static let space3: CGFloat = 12  // list-row vertical padding
    public static let space4: CGFloat = 16  // section gutter, window content inset
    public static let space5: CGFloat = 20  // group separation
