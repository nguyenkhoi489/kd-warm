...
public enum KTType {
    ...
    public static let modalTitle = Font.system(size: 17, weight: .bold)
    public static let cardName = Font.system(size: 14, weight: .semibold)
    public static let rowName = Font.system(size: 13.5, weight: .semibold)
    public static let label = Font.system(size: 13, weight: .semibold)
    public static let body = Font.system(size: 13)
    public static let control = Font.system(size: 12.5, weight: .medium)
    public static let sub = Font.system(size: 12)
    public static let sub13 = Font.system(size: 12.5)
