...
final class DNSConstantsTests: XCTestCase {
    ...
    func testDaemonPlistReferencesBinaryAndLabel() {
        ...
        XCTAssertTrue(plist.contains("<string>com.kdwarm.dnsmasq</string>"))
...
final class HelperIdentityTests: XCTestCase {
    func testDevBuildHasNoSigningIdentityAndIdentifierOnlyRequirement() {
        ...
        XCTAssertEqual(HelperIdentity.clientRequirement, "identifier \"com.kdwarm.app\"")
        XCTAssertEqual(HelperIdentity.helperRequirement, "identifier \"com.kdwarm.helper\"")
    }

    func testIdentifiersAreConsistent() {
        XCTAssertEqual(HelperIdentity.machServiceName, "com.kdwarm.helper")
        XCTAssertEqual(HelperIdentity.appBundleID, "com.kdwarm.app")
    }
}
...
final class Port53ConflictTests: XCTestCase {
    func testForeignProcessIsNamedConflictOwnDnsmasqIsNot() {
        ...
        XCTAssertTrue(Port53ConflictDetector.isOwn("com.kdwarm.dnsmasq"))
