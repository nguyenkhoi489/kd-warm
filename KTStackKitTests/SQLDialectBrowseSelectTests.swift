...
final class SQLDialectBrowseSelectTests: XCTestCase {
    ...
    func testPlainBrowseSelectHasNoWhereOrOrderBy() throws {
        let stmt = try mysql.browseSelect(schema: "db", table: "t",
                                          filters: [], sort: nil, limit: 100, offset: 0)
    ...
    func testNullOperatorsDoNotBind() throws {
        let stmt = try mysql.browseSelect(
            schema: "db", table: "t",
            filters: [FilterCondition(column: "a", op: .isNull),
    ...
    func testLimitAndOffsetAreClampedToSafeValues() throws {
        let stmt = try mysql.browseSelect(schema: "db", table: "t", filters: [], sort: nil,
                                          limit: 0, offset: -5)
